...
CATALOG = {
    ...
    "DOCUMENT_COLLECTION": {
        ...
        "document": [
            ("cc_offer_letter", "Current company â Offer Letter"),
            ("cc_role_change_letter", "Current company â Role Change Letter"),
            ("cc_experience_letter", "Current company â Experience Letter"),
            ("cc_relieving_letter", "Current company â Relieving Letter"),
            ("cc_pay_slips", "Current company â Last 3 Months Pay Slips"),
            ("pc1_offer_letter", "Previous company 1 â Offer Letter"),
            ("pc1_role_change_letter", "Previous company 1 â Role Change Letter"),
            ("pc1_experience_letter", "Previous company 1 â Experience Letter"),
            ("pc1_relieving_letter", "Previous company 1 â Relieving Letter"),
            ("pc1_pay_slips", "Previous company 1 â Last 3 Months Pay Slips"),
            ("pc2_offer_letter", "Previous company 2 â Offer Letter"),
            ("pc2_role_change_letter", "Previous company 2 â Role Change Letter"),
            ("pc2_experience_letter", "Previous company 2 â Experience Letter"),
            ("pc2_relieving_letter", "Previous company 2 â Relieving Letter"),
            ("pc2_pay_slips", "Previous company 2 â Last 3 Months Pay Slips"),
            ("pc3_offer_letter", "Previous company 3 â Offer Letter"),
            ("pc3_role_change_letter", "Previous company 3 â Role Change Letter"),
            ("pc3_experience_letter", "Previous company 3 â Experience Letter"),
            ("pc3_relieving_letter", "Previous company 3 â Relieving Letter"),
            ("pc3_pay_slips", "Previous company 3 â Last 3 Months Pay Slips"),
            ("pc4_offer_letter", "Previous company 4 â Offer Letter"),
            ("pc4_role_change_letter", "Previous company 4 â Role Change Letter"),
            ("pc4_experience_letter", "Previous company 4 â Experience Letter"),
            ("pc4_relieving_letter", "Previous company 4 â Relieving Letter"),
            ("pc4_pay_slips", "Previous company 4 â Last 3 Months Pay Slips"),
            ("marksheet_10", "10th Marks Sheet"),
            ("marksheet_12_diploma", "12th Marks Sheet / Diploma"),
            ("ug_consolidated_marksheet", "UG â Consolidated Marksheet"),
            ("ug_certificate", "UG Certificate"),
            ("pg_consolidated_marksheet", "PG â Consolidated Marksheet"),
    ...
    "BGV": {
        ...
        "document": [
            ...
            ("form16_last_year", "Form 16 / ITR â Last Year"),
            ("form16_previous_year", "Form 16 / ITR â Previous Year"),
            ("bank_statement_salary", "Bank Statement (salary credits, 3â6 months)"),
