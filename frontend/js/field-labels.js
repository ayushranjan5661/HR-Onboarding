...
const BGV_TABLE_COLUMNS = {
  ...
  bgv_education_checks: ["qualification", "institution", "university_board", "roll_number", "registration_number", "year_of_passing", "course_name", "field_of_study", "grade_percentage", "course_length", "study_mode", "verification_contact"],
  bgv_employment_checks: ["company_name", "company_address", "last_working_city", "employee_id", "name_as_per_company_records", "designation_joining", "designation_leaving", "job_description", "from_date", "to_date", "employment_type", "payroll_company", "last_drawn_ctc", "manager_name", "manager_designation", "manager_email", "manager_phone", "hr_name", "hr_email", "hr_phone", "reason_for_leaving", "eligible_for_rehire", "may_contact_now"],
